...
</script>	<noscript><meta http-equiv="refresh" content="0; URL=/files/U84CYJC2W/F8768KZHU/pp_script.r?nojsmode=1" /></noscript>
...
(function() {
	...
	<script type="text/javascript" src="https://a.slack-edge.com/bv1-1/webpack.manifest.29678882ea7abbbcc200.min.js" crossorigin="anonymous" onload="window._cdn && _cdn.ok(this, arguments)" onerror="window._cdn && _cdn.failed(this, arguments)"></script>
...
<script>TSSSB.env = (function() {
	...
	<script type="text/javascript">
		...
		window.addEventListener('load', function() {
	        ...
	        <title>pp_script.R | Divide and Conquer Slack</title>
	...
	<div id="site_nav_contents">
		...
		<div id="footer">
			...
			<ul id="footer_nav">
				...
				<li><a href="https://slack.com/signout/277518087239?crumb=s-1511891060-3554284ad1-%E2%98%83" data-qa="sign_out">Sign Out<i class="ts_icon ts_icon_sign_out small_left_margin ts_icon_inherit"></i></a></li>
			</ul>
...
<p class="print_only">
	...
	<span class="subtle_silver break_word">https://divide-and-conquer-mn.slack.com/files/U84CYJC2W/F8768KZHU/pp_script.r</span>
</p>
...
<div class="file_public_link_shared alert" style="display: none;">
	...
	<i class="ts_icon ts_icon_link"></i> Public Link: <a class="file_public_link" href="https://slack-files.com/T85F82K71-F8768KZHU-a7d7cf77db" target="new">https://slack-files.com/T85F82K71-F8768KZHU-a7d7cf77db</a>
</div></div>
...
<div id="file_page" class="card top_padding">
	...
	<p class="small subtle_silver no_print meta">
		...
		2KB R snippet created on <span class="date">November 28, 2017</span>.
...
print(training.accuracy)</pre>
	...
	<form action="https://divide-and-conquer-mn.slack.com/files/U84CYJC2W/F8768KZHU/pp_script.r"
		...
		<input type="hidden" name="crumb" value="s-1511891060-e53542af54-☃" />
...
<!--
	...
	var boot_data = {
		...
		no_login: false,
		version_ts: '1511890772',
		version_uid: 'da431b8096c8b35fe2e1e3dc02df241b66ed992e',
	...
	// client boot data
		...
		boot_data.ms_connect_url = "wss:\/\/mpmulti-zWWf.lb.slack-msgs.com\/?flannel=2&token=xoxs-277518087239-277546134369-278951747638-7e53c8995f";
...
<script type="text/javascript" src="https://a.slack-edge.com/bv1-1/application.49a53294afd421b1c4cd.min.js" crossorigin="anonymous" onload="window._cdn && _cdn.ok(this, arguments)" onerror="window._cdn && _cdn.failed(this, arguments)"></script>
...
<script type="text/javascript" src="https://a.slack-edge.com/bv1-1/codemirror_load.0e1999f4ce5168fec6cb.min.js" crossorigin="anonymous" onload="window._cdn && _cdn.ok(this, arguments)" onerror="window._cdn && _cdn.failed(this, arguments)"></script>
	...
	<!--
		...
		boot_data.file = {"id":"F8768KZHU","created":1511852540,"timestamp":1511852540,"name":"pp_script.R","title":"pp_script.R","mimetype":"text\/plain","filetype":"r","pretty_type":"R","user":"U84CYJC2W","editable":true,"size":1982,"mode":"snippet","is_external":false,"external_type":"","is_public":true,"public_url_shared":false,"display_as_bot":false,"username":"","url_private":"https:\/\/files.slack.com\/files-pri\/T85F82K71-F8768KZHU\/pp_script.r","url_private_download":"https:\/\/files.slack.com\/files-pri\/T85F82K71-F8768KZHU\/download\/pp_script.r","permalink":"https:\/\/divide-and-conquer-mn.slack.com\/files\/U84CYJC2W\/F8768KZHU\/pp_script.r","permalink_public":"https:\/\/slack-files.com\/T85F82K71-F8768KZHU-a7d7cf77db","edit_link":"https:\/\/divide-and-conquer-mn.slack.com\/files\/U84CYJC2W\/F8768KZHU\/pp_script.r\/edit","preview":"##########################################################################\n####### Run this part of the script to investigate processing ############\n##########################################################################\n\n# Load data","preview_highlight":"\u003Cdiv class=\"CodeMirror cm-s-default CodeMirrorServer\" oncopy=\"if(event.clipboardData){event.clipboardData.setData('text\/plain',window.getSelection().toString().replace(\/\\u200b\/g,''));event.preventDefault();event.stopPropagation();}\"\u003E\n\u003Cdiv class=\"CodeMirror-code\"\u003E\n\u003Cdiv\u003E\u003Cpre\u003E\u003Cspan class=\"cm-comment\"\u003E##########################################################################\u003C\/span\u003E\u003C\/pre\u003E\u003C\/div\u003E\n\u003Cdiv\u003E\u003Cpre\u003E\u003Cspan class=\"cm-comment\"\u003E####### Run this part of the script to investigate processing ############\u003C\/span\u003E\u003C\/pre\u003E\u003C\/div\u003E\n\u003Cdiv\u003E\u003Cpre\u003E\u003Cspan class=\"cm-comment\"\u003E##########################################################################\u003C\/span\u003E\u003C\/pre\u003E\u003C\/div\u003E\n\u003Cdiv\u003E\u003Cpre\u003E&#8203;\u003C\/pre\u003E\u003C\/div\u003E\n\u003Cdiv\u003E\u003Cpre\u003E\u003Cspan class=\"cm-comment\"\u003E# Load data\u003C\/span\u003E\u003C\/pre\u003E\u003C\/div\u003E\n\u003C\/div\u003E\n\u003C\/div\u003E\n","lines":56,"lines_more":51,"preview_is_truncated":true,"channels":["C85F82R9D"],"groups":[],"ims":[],"comments_count":0};
...
<!-- slack-www-hhvm-0ffc91841c3c5a645 / 2017-11-28 09:44:20 / vda431b8096c8b35fe2e1e3dc02df241b66ed992e / B:H -->
